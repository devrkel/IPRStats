...
""")
    ...
    def OnSettings(self, event):
        settings = SettingsDlg(None, -1, 'Change Settings')
        settings.ShowModal()
        settings.Destroy()
...
class SettingsDlg(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.SessionDirTxt = wx.TextCtrl(self.GeneralTab, -1, ".session/")
        ...
        self.LDBHostTxt = wx.TextCtrl(self.DBSettingsTab, -1, "localhost")
        self.LDBUserLbl = wx.StaticText(self.DBSettingsTab, -1, "User:  ")
        self.LDBUserTxt = wx.TextCtrl(self.DBSettingsTab, -1, "root")
        self.LDBPasswrdLbl = wx.StaticText(self.DBSettingsTab, -1, "Password")
        self.LDBPasswrdTxt = wx.TextCtrl(self.DBSettingsTab, -1, "password", style=wx.TE_PASSWORD)
        self.LDBPortLbl = wx.StaticText(self.DBSettingsTab, -1, "Port:  ")
        self.LDBPortSpn = wx.SpinCtrl(self.DBSettingsTab, -1, "3306", min=0, max=10000)
        self.LDBDatabaseLbl = wx.StaticText(self.DBSettingsTab, -1, "Database:  ")
        self.LDBDatabaseTxt = wx.TextCtrl(self.DBSettingsTab, -1, "iprstats")
        self.GDBHostLbl = wx.StaticText(self.DBSettingsTab, -1, "Host:  ")
        self.GDBHostTxt = wx.TextCtrl(self.DBSettingsTab, -1, "mysql.ebi.ac.uk")
        self.GDBUserLbl = wx.StaticText(self.DBSettingsTab, -1, "User:  ")
        self.GDBUserTxt = wx.TextCtrl(self.DBSettingsTab, -1, "go_select")
        self.GDBPasswrdLbl = wx.StaticText(self.DBSettingsTab, -1, "Password")
        self.GDBPasswrdTxt = wx.TextCtrl(self.DBSettingsTab, -1, "amigo", style=wx.TE_PASSWORD)
        self.GDBPortLbl = wx.StaticText(self.DBSettingsTab, -1, "Port:  ")
        self.GDBPortSpn = wx.SpinCtrl(self.DBSettingsTab, -1, "4085", min=0, max=10000)
        self.GDBDatabaseLbl = wx.StaticText(self.DBSettingsTab, -1, "Database:  ")
        self.GDBDatabaseTxt = wx.TextCtrl(self.DBSettingsTab, -1, "go_latest")
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add(self.ApplyBtn, 0, wx.ADJUST_MINSIZE, 0)
        grid_sizer_1.Add(self.CancelBtn, 0, wx.ADJUST_MINSIZE, 0)
        grid_sizer_1.Add(self.OKBtn, 0, wx.ADJUST_MINSIZE, 0)
        MainSzr.Add(grid_sizer_1, 1, wx.ALIGN_RIGHT, 0)
